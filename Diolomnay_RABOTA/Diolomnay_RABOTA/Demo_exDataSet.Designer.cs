...
namespace Diolomnay_RABOTA.Demo_exDataSetTableAdapters {
...
SELECT Номер, Дата, [Этап выполнения], Заказчик, Менеджер, Стоимость FROM Заказ WHERE (Дата = @Дата) AND (Номер = @Номер)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Diolomnay_RABOTA.Properties.Settings.Default.Demo_exConnectionString;
        }
